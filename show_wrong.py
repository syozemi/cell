...
def eval(seed):
    ...
    for i,x in enumerate(wrong_list):
        ...
        plt.imsave(fname='wrong/unet2/%d/%dimage.png' % (seed, i), arr=img, cmap='gray', format='png')
        plt.imsave(fname='wrong/unet2/%d/%dmask.png' % (seed, i), arr = msk, cmap='gray', format='png')
        plt.imsave(fname='wrong/unet2/%d/%dprediction.png' % (seed, i), arr = pred, cmap='gray', format='png')
