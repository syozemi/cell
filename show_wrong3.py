...
def eval(seed):
    ...
    for i,x in enumerate(wrong_list):
        ...
        plt.imsave(fname='wrong/unet3/%d/image%d.png' % (seed, i), arr=img, cmap='gray', format='png')
        plt.imsave(fname='wrong/unet3/%d/mask%d.png' % (seed, i), arr = msk, cmap='gray', format='png')
        plt.imsave(fname='wrong/unet3/%d/prediction%d.png' % (seed, i), arr = pred, cmap='gray', format='png')
